...
"""
name = "Rui Qi huang"  # TODO: your name
SID = 917292550  # TODO: your student id
git_username = "RuiQiHuang1832"  # TODO: your github username
print(name)
print(SID)
print(git_username)
print('\n')
...
class Department(object):
    ...
    def add_employee(self, employee_name):
        ...
        employee = Department(employee_name)
...
class Manager(Employee):
    ...
    def manager_info(self):
        ...
        """
        return Employee.info(self) + " with manager id: " + str(self.managerID)
...
class TestCases(unittest.TestCase):
    ...
    def testP3(self):
        ...
        self.assertEqual(manager_sarah.manager_info(),
                         "Sarah works in the Engineering department with manager id: " + str(9167766))
        self.assertEqual(manager_john.manager_info(),
                         "John works in the Marketing department with manager id: " + str(2887766))
